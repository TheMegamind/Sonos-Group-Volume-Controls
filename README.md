...
2. Add [https://github.com/TheMegamind/Sonos-Group-Volume-Controls](https://github.com/TheMegamind/Sonos-Group-Volume-Controls), set the **Type** to **Integration**, and click **Add**.
